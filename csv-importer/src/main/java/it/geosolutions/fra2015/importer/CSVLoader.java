...
public class CSVLoader {
    ...
    public CSVLoader(String pathCSV){
        ...
        try {
            ...
            throw new IllegalArgumentException("Error loading the input file: '" + pathCSV + "'");
        }
